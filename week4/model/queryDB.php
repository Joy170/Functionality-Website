	...
	if($run == true){
		...
		if($res){
			...
			echo "<script type='text/javascript'>location.href = 'https://mayar.abertay.ac.uk/~1704097/306/week4/view/login.php';</script>";
		} 
		else{
	...
	echo "<script type='text/javascript'>location.href = 'https://mayar.abertay.ac.uk/~1704097/306/week4/view/displayallItems.php';</script>";
	}
	else{
